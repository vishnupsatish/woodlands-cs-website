...
## Example 1
In our first meeting, we created a program (**Pythagorean Theorem**) that calculated the value of <img src="/assets/img/lesson-11-01/pythagorean.png" alt="" class="post-img">.
